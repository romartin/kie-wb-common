...
import org.kie.workbench.common.stunner.core.client.service.AbstractClientDiagramServices;
 ...
 */
@ApplicationScoped
public class ClientProjectDiagramServices extends AbstractClientDiagramServices<ProjectDiagram, ProjectDiagramService> {

    protected ClientProjectDiagramServices() {
        this( null, null, null );
    }

    @Inject
    public ClientProjectDiagramServices( final ShapeManager shapeManager,
