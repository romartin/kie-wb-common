...
public class ClientProjectSessionManagerTest {
    ...
    @Mock ProjectDiagramWorkbenchDocks editorDocks;
    @Mock PlatformManager platformManager;
    @Mock EventSourceMock<SessionOpenedEvent> sessionOpenedEvent;
    @Mock EventSourceMock<SessionDisposedEvent> sessionDisposedEvent;
    @Mock EventSourceMock<SessionPausedEvent> sessionPausedEvent;
    @Mock EventSourceMock<SessionResumedEvent> sessionResumedEvent;
