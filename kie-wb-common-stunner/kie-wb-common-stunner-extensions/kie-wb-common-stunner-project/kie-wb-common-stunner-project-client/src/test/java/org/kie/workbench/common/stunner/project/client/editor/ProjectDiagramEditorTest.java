...
public class ProjectDiagramEditorTest {
    ...
    @Mock AbstractProjectDiagramEditor.View view;
    @Mock PlaceManager placeManager;
    @Mock ErrorPopupPresenter errorPopupPresenter;
    @Mock EventSourceMock<ChangeTitleWidgetEvent> changeTitleNotificationEvent;
    @Mock SavePopUpPresenter savePopUpPresenter;
    @Mock ClientResourceType resourceType;
    @Mock ClientProjectDiagramServices projectDiagramServices;
    @Mock AbstractClientSessionManager clientSessionManager;
    @Mock AbstractClientSessionPresenter clientSessionPresenter;
    @Mock BS3PaletteFactory paletteFactory;
    @Mock ClientSessionUtils sessionUtils;
    @Mock SessionCommandFactory sessionCommandFactory;
    @Mock ProjectDiagramEditorMenuItemsBuilder menuItemsBuilder;

    @Mock ClearSelectionSessionCommand sessionClearSelectionCommand;
    @Mock VisitGraphSessionCommand sessionVisitGraphCommand;
    @Mock SwitchGridSessionCommand sessionSwitchGridCommand;
    @Mock ClearSessionCommand sessionClearCommand;
    @Mock DeleteSelectionSessionCommand sessionDeleteSelectionCommand;
    @Mock UndoSessionCommand sessionUndoCommand;
    @Mock ValidateSessionCommand sessionValidateCommand;

    @Mock AbstractClientFullSession fullSession;
    @Mock ClientSessionPresenter.View clientSessionPresenterView;
    @Mock ObservablePath path;
