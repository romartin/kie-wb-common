...
public class ProjectDiagramNewResourceHandlerTest {
    ...
    @Mock ClientResourceType projectDiagramResourceType;
    @Mock TypeDefinitionSetRegistry definitionSetRegistry;
    @Mock AdapterManager adapterManager;
    @Mock DefinitionSetAdapter definitionSetAdapter;
    @Mock Object definitionSet;
    @Mock Package aPackage;
    @Mock NewResourcePresenter presenter;
    @Mock Path path;
    ...
    public void testCreate() {
        ...
        verify( projectDiagramServices, times( 1 ) ).create( eq( path ), eq( "file1.bpmn2"),
    ...
    private class ProjectDiagramNewResourceHandlerStub extends AbstractProjectDiagramNewResourceHandler<ClientResourceType> {
        ...
        public ProjectDiagramNewResourceHandlerStub( DefinitionManager definitionManager,
                                                     ClientProjectDiagramServices projectDiagramServices,
