...
public class LocationControlImplTest {
    ...
    public void testMove() throws Exception {
        ...
        final NFastArrayList<WiresConnection> connections = NFastArrayList.fromObjects(connection);
        final WiresConnector connector = mock(WiresConnector.class);
        final String connectorUUID = UUID.uuid();
        final NFastArrayList<WiresShape> children = NFastArrayList.fromObjects(childWiresShape);
        ...
        final Point2DArray controlPointsLienzo = Point2DArray.fromArrayOfPoint2D(controlPointLienzo);
        final ViewConnector viewConnector = mock(ViewConnector.class);
        Group parentGroup = mock(Group.class);
        BoundingBox parentBB = BoundingBox.fromDoubles(0, 0, 200, 200);
