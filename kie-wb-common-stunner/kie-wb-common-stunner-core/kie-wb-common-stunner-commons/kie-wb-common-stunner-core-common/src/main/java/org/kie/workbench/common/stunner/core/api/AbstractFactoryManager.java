...
public abstract class AbstractFactoryManager {
    ...
    public <D extends Diagram> D newDiagram( final String name,
        ...
        final Metadata metadata = buildMetadata( id );
    ...
    protected Metadata buildMetadata( final String defSetId ) {
        return new MetadataImpl.MetadataImplBuilder( defSetId, definitionManager ).build();
    }
