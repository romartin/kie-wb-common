 ...
 */
@ApplicationScoped
public class ClientDiagramServices extends AbstractClientDiagramServices<Diagram, DiagramService> {
    ...
    @Inject
    public ClientDiagramServices( final ShapeManager shapeManager,
