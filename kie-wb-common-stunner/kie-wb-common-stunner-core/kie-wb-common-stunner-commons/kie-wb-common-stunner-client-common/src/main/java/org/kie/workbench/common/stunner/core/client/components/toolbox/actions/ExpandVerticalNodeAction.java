...
@Dependent
public class ExpandVerticalNodeAction implements ToolboxAction<AbstractCanvasHandler> {

    private final ClientTranslationService translationService;
    private final SessionCommandManager<AbstractCanvasHandler> sessionCommandManager;
    private final CanvasCommandFactory<AbstractCanvasHandler> commandFactory;
    private static final SvgDataUriGlyph GLYPH =
            SvgDataUriGlyph.Builder.build(StunnerCommonImageResources.INSTANCE.expandVertical().getSafeUri());

    @Inject
    public ExpandVerticalNodeAction(final ClientTranslationService translationService,
    ...
    public ToolboxAction<AbstractCanvasHandler> onMouseClick(final AbstractCanvasHandler canvasHandler,
        ...
        sessionCommandManager.execute(canvasHandler,
                                      commandFactory.expandVertical(node));
        return this;
    }
}
