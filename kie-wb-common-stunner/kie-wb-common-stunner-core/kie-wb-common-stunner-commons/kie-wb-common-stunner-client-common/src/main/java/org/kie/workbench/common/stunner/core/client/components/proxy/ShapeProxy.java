...
public interface ShapeProxy<H extends CanvasHandler, T extends ShapeProxy.ShapeProxyArguments<H>> {

    abstract class ShapeProxyArguments<H extends CanvasHandler> {
