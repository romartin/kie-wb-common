...
public abstract class AbstractClientDiagramServices<D extends Diagram, S extends BaseDiagramService<D>> {

    private ShapeManager shapeManager;
    protected Caller<S> diagramServiceCaller;
    protected Caller<DiagramLookupService> diagramLookupServiceCaller;

    public AbstractClientDiagramServices( final ShapeManager shapeManager,
