...
@ApplicationScoped
public class BasicSetBackendServices extends AbstractDefinitionSetServices {

    private ErraiDiagramMarshaller erraiDiagramMarshaller;
    private BasicSetResourceType basicSetResourceType;

    protected BasicSetBackendServices() {
        this( null, null );
    }

    @Inject
    public BasicSetBackendServices( ErraiDiagramMarshaller erraiDiagramMarshaller,
