...
/**
 * Use this alternative to override defaults - the workbench resources with suffix "bpmn2" will be bind to Stunner's editor.
 */
@ApplicationScoped
@Alternative
public class BPMN2DefinitionSetResourceType
