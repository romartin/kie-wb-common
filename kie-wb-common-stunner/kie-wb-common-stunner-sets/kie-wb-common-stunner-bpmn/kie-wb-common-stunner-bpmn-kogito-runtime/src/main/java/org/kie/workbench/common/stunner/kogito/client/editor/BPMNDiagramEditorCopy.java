...
// @ApplicationScoped
// @DiagramEditor
// @WorkbenchClientEditor(identifier = BPMNDiagramEditorCopy.EDITOR_ID)
class BPMNDiagramEditorCopy extends AbstractDiagramEditor {
    ...
    //@Inject
    public BPMNDiagramEditorCopy(final View view,
                                                      ...
                                                      getEditor().open(diagram,
                                                                       new Viewer.Callback() {
                                                                           ...
                                                                           public void onError(ClientRuntimeError error) {
                                                                               BPMNDiagramEditorCopy.this.getEditor().onLoadError(error);
