...
@ApplicationScoped
public class BPMNBackendServices extends AbstractDefinitionSetServices {

    @Inject
    private BPMNDefinitionSetResourceType bpmnResourceType;

    protected BPMNBackendServices() {
        this( null, null );
    }

    @Inject
    public BPMNBackendServices( BPMNDiagramMarshaller bpmnDiagramMarshaller,
